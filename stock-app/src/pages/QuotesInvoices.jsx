  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const documentData = {
        ...
        showDiscountDetailsInPDF: wizardData.showDiscountDetailsInPDF,
    ...
    switch (currentStep) {
      ...
      case 3:
        return <PricingStep 
          ...
          showDiscountDetailsInPDF={wizardData.showDiscountDetailsInPDF}
          setShowDiscountDetailsInPDF={(showDiscountDetailsInPDF) => setWizardData(prev => ({ ...prev, showDiscountDetailsInPDF }))}
        />
      case 4:
        return <PreviewStep 
          clientInfo={wizardData.clientInfo}
        ...
        {selectedItems.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            <div className="mt-6 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border border-gray-200">
              ...
              <div className="mb-6">
                <h6 className="text-sm font-medium text-gray-700 mb-3">Choisissez votre mode de calcul :</h6>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    ...
                    if (discountValue === 0) {
                      setDiscountValue(10) // Valeur par défaut
                    }
                  }}>
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xs text-gray-600 mb-3">Appliquez une remise en pourcentage ou montant fixe</p>
                        ...
                        <div className="flex items-center space-x-4">
                          <label className="flex items-center">
                            <input
                              ...
                              onClick={(e) => e.stopPropagation()}
                            />
                            <span className="ml-2 text-xs text-gray-700">Afficher dans le PDF</span>
                          </label>
                          ...
                          {showDiscountInPDF && (
                            <label className="flex items-center">
                              <input
                                ...
                                onClick={(e) => e.stopPropagation()}
                              />
                              <span className="ml-2 text-xs text-gray-700">Détails complets</span>
                            </label>
                          )}
                        </div>
                      </div>
                  ...
                  <div className={`p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    ...
                    if (customAmount === 0) {
                      setCustomAmount(subtotalAfterDiscount)
                    }
                  }}>
                    <div className="flex items-center justify-between mb-2">
                    ...
                    <p className="text-xs text-gray-600 mb-3">Définissez un montant final personnalisé</p>
...
function PreviewStep({ clientInfo, selectedItems, totalAmount, calculatedAmount, customAmount, showCalculatedAmount, discountType, discountValue, showDiscountInPDF, showNetAmountInPDF, showFinalAmountInPDF, showDiscountDetailsInPDF, date, isQuote, shopInfo }) {
