 ...
 */
export default function InvoicesList({ invoices, onEdit, onDelete, onDownload }) {
  if (invoices.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 max-w-md mx-auto border border-green-100">
          ...
          <p className="text-gray-600">Commencez par créer votre première facture.</p>
        </div>
      </div>
    )
  }
