...
export class CreditService {
  ...
  /**
   * Récupérer tous les crédits d'un magasin avec filtres
   */
  static async getCredits(shopId, filters = {}) {
    try {
      ...
      // Trier côté client si nécessaire (en attendant que les index soient créés)
   ...
   */
  static subscribeToCredits(shopId, callback) {
    const q = query(
      collection(db, 'credits'),
      where('shopId', '==', shopId),
